...
def test_make_plot_with_specific_limits():
    ...
    fig = make_plot(limits=limits, out="test_make_plot_with_specific_limits.pdf")
    assert fig is not None
...
def test_make_plot_with_multiple_theories():
    ...
    fig = make_plot(theories=theories, out="test_make_plot_with_multiple_theories.pdf")
    assert fig is not None
...
def test_make_plot_with_z_range():
    ...
    fig = make_plot(z_range=(6.0, 10.0), out="test_make_plot_with_z_range.pdf")
    assert fig is not None


def test_make_plot_with_k_range():
    """Test making a plot with k range filtering."""
    fig = make_plot(k_range=(0.1, 1.0), out="test_make_plot_with_k_range.pdf")
    assert fig is not None
...
def test_make_plot_no_shade_limits():
    ...
    fig = make_plot(shade_limits=None, out="test_make_plot_no_shade_limits.pdf")
    assert fig is not None
...
def test_make_plot_with_aspoints():
    ...
    fig = make_plot(
        limits=limits, aspoints=limits, out="test_make_plot_with_aspoints.pdf"
    )
    assert fig is not None
...
def test_make_plot_with_aslines():
    ...
    limits = list(KNOWN_LIMITS.keys())[:2]
    fig = make_plot(
        limits=limits, aslines=limits, out="test_make_plot_with_aslines.pdf"
    )
    assert fig is not None
...
def test_make_plot_custom_fig_ratio():
    ...
    fig = make_plot(fig_ratio=2.0, out="test_make_plot_custom_fig_ratio.pdf")
    assert fig is not None
